...
export const UserProfileModal = ({ userId, open, onOpenChange }: UserProfileModalProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="card-steel max-w-2xl max-h-[90vh] overflow-y-auto min-h-[400px] !transition-none !animate-none">
        ...
        {isLoading ? (
          ...
          <div className="space-y-6 !transition-none">
            {/* Profile Info */}
            <Card className="bg-steel-800/50 border-steel-600 p-6 !transition-none">
