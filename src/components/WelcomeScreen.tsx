  ...
  const features = [
    {
      ...
      description: 'Полная защита работодателей и исполнителей через систему гарантий'
    },
    {
      icon: Users,
      title: 'Проверенные исполнители',
      description: 'Система рейтингов и отзывов для надежных специалистов'
    },
    {
      icon: Zap,
      title: 'Быстрый найм',
      description: 'Мгновенные уведомления и быстрый поиск исполнителей'
    },
    {
      icon: Trophy,
      title: 'Честная оплата',
      description: 'Ежедневная оплата и справедливые расценки за работу'
    }
  ];
      ...
      <div className="max-w-4xl mx-auto w-full space-y-8">
        ...
        <div className="text-center space-y-6">
          ...
          <p className="text-xl md:text-2xl text-steel-300 max-w-3xl mx-auto leading-relaxed font-medium">
            Платформа для поиска и найма исполнителей на краткосрочные работы. 
            Найдите надежных специалистов или предложите свои услуги с ежедневной оплатой.
          </p>
        </div>
